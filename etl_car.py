...
def extract_from_xml(file_to_process):
    ...
    for person in root:
        ...
        dataframe = pd.concat([dataframe, pd.DataFrame({'year_of_manufacture': [year_of_manufacture], 'price': [price], 'fuel': [fuel]})], ignore_index=True)
        #dataframe = dataframe.append({'year_of_manufacture': year_of_manufacture, 'price': price, 'fuel': fuel}, ignore_index=True)
    return dataframe
